              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  {whatsappLink ? (
                    ...
                    >
                      <button className="w-full bg-gradient-to-r from-[#25D366] to-[#20B85] hover:from-[#22c35e] hover:to-[#1DC461] text-white font-semibold py-3 px-6 rounded-xl shadow-lg shadow-[#25D366]/20 hover:shadow-[#25D366]/40 transition-all duration-300 flex items-center justify-center gap-3 transform hover:scale-[1.02] active:scale-[0.98]">
